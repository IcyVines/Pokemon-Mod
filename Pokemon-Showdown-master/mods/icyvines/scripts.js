...
exports.BattleScripts = {
	init: function () {
		...
		// Azurill
		this.modData('Learnsets', 'azurill').learnset.dragontail = ['5L100'];
		this.modData('Learnsets', 'azurill').learnset.playrough = ['5L100'];
		this.modData('Learnsets', 'azurill').learnset.tailslap = ['5L100'];
		this.modData('Learnsets', 'azurill').learnset.poisontail = ['5L100'];
		this.modData('Learnsets', 'azurill').learnset.aquatail = ['5L100'];
		this.modData('Learnsets', 'azurill').learnset.bellydrum = ['5L100'];
